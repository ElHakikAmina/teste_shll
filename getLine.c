 ...
 * Return: bytes read
 */
ssize_t input_buf(info_t_struct *info, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
 ...
 * Return: bytes read
 */
ssize_t get_input(info_t_struct *info)
{
 ...
 * Return: r
 */
ssize_t read_buf(info_t_struct *info, char *buf, size_t *i)
{
	ssize_t r = 0;
 ...
 * Return: s
 */
int _getlinefnc(info_t_struct *info, char **ptr, size_t *length)
{
